...
const HomeIcon = (props) => (
  ...
  >
    ...
    <g filter="url(#b)">
      <path fill="url(#c)" d="M150.737 0H119v31.737h31.737V0Z" />
      <path fill="url(#d)" d="M180.49.793h-31.737V32.53h31.737V.793Z" />
    </g>
    <defs>
      <pattern
        id="c"
      ...
      >
        <use xlinkHref="#e" transform="scale(.0125)" />
      </pattern>
      <pattern
        id="d"
        width={1}
        ...
        patternContentUnits="objectBoundingBox"
      >
        <use xlinkHref="#f" transform="scale(.0125)" />
      </pattern>
      <filter
        id="a"
        width={120.485}
